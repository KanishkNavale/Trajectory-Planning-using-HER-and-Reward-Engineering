...
class Critic(tf.keras.Model):
    ...
    def __init__(self, dim_actions, H1_dim=256, H2_dim=256, name='critic'):
...
class Actor(tf.keras.Model):
    ...
    def __init__(self, dim_actions, H1_dim=256, H2_dim=256, name='actor'):
...
class Agent:
    ...
    def __init__(self, input_dims, alpha=0.0001, beta=0.001, env=None,
                 ...
                 H1=256, H2=256, batch_size=256, noise=0.1):
        self.gamma = gamma
        self.tau = tau
