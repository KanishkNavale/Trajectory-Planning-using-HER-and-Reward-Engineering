...
if __name__ == '__main__':
    ...
    # Plot the data
    her = plot_graph(her, 25, 'red', 'HER: Accumulated Rewards vs Episodes')
    re = plot_graph(re, 25, 'blue', 'Reward Engg: Accumulated Rewards vs Episodes')
    her_re = plot_graph(her_re, 25, 'green', 'HER + Reward Engg: Accumulated Rewards vs Episodes')
