...
from algorithms.PDDPG import Agent
from algorithms.augmentations import dense_reward

# Init. tensorboard summary writer
tb = SummaryWriter(log_dir=os.path.abspath('dense_rewards/prioritized/data/tensorboard'))
...
if __name__ == '__main__':
    ...
    # Init. Datapath
    data_path = os.path.abspath('dense_rewards/prioritized/data')
    ...
    for i in range(n_games):
        ...
        while not done:
            ...
            # Compute augmented rewards and done flags
            reward = dense_reward(next_desgoal, curr_actgoal)
